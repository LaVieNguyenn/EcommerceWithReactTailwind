    ...
    <div className="min-h-[500px] flex justify-center items-center py-12 sm:py-0">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div
            className="flex flex-col gap-6 justify-center sm:pt-0"
            data-aos="fade-left"
          >
            <h1 data-aos="fade-up" className="text-3xl sm:text-4xl font-bold">
              Winter Sale Upto 50% Off
            </h1>
            <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading5">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore
              dolorem quam ad aspernatur aut in, voluptates ut, a explicabo quas
              recusandae fugit cum nihil enim voluptatibus rem dolor ratione
              incidunt!
            </p>
